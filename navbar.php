<nav class="navbar navbar-expand-lg fixed-top bg-cocoa border-bottom botder- gold dhadow-sm py-3">
    <div class= "container">
        ...
        <div class="collapse navbar-collapse" id="internshipNavbar">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-2">
                <li class="nav-item"><a class="nav-link text-champagne px-3" href="index.php">Home</a></li>
                <li class="nav-item"><a class="nav-link text-champagne px-3" href="login.php">Login</a></li>
                <li class="nav-item"><a class="nav-link btn btn-outline-gold text-gold ms-lg-2 px-4" href="register.php">Register</a></li>
            </ul>
        </div>
    </div>
</nav>        